    ...
    <>
      ...
      <h1 className='font-bold text-center text-3xl'>C-Task - Manage your todos at one place</h1>
        <div className="addtodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-gray-600 hover:bg-red-800 p-4 py-2 text-sm font-bold text-white rounded-full mx-2 ' >Add</button>
          </div>
        </div>
